...
const DELEGATION_SECTION = `${DELEGATION_HEADING}
...
// settings the agent honours. Ships in the project template and is back-filled into
// existing projects by the schema 5 → 6 migration. The first heading doubles as the
// idempotency marker, exactly like DELEGATION_HEADING.
const ORCHESTRATION_HEADING = '## Reviewing a delegated PR (review → fix → re-review)';

const ORCHESTRATION_SECTION = `${ORCHESTRATION_HEADING}
...
${DELEGATION_SECTION}${ORCHESTRATION_SECTION}## Cross-cutting conventions
