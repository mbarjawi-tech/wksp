...
function reportPartialSetup(taskId, repoName, detail, opts = {}) {
  ...
  console.error('\n  Everything decided before this point has been saved, and nothing was undone.');
    ...
    applyRepoPlan(items, {
      ...
      fail: msg => {
        ...
        reportPartialSetup(taskId, null, null, {
          ...
          reRunNote: `The task itself is fine — only ${repoArg} was left as it was.`,
          discard:   false,
        });
        process.exit(1);
      },
